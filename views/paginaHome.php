        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="/cadastrar-receitas">Envie sua receita</a></li>
              <li><a class="dropdown-item" href="/favoritas">Receitas Favoritas
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" fill="red" class="bi bi-heart-fill" viewBox="0 0 16 16">
